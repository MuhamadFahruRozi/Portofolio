...
const AboutEdit = ({ user }) => {
    ...
    useEffect(() => {
        const getAbout = async () => {
            const res = await axios.get('http://localhost:8000/api/about/About-144-867-936');
            console.log(res);
    ...
    const onSubmitFED = async (e) => {
        ...
        const url ='http://localhost:8000/api/about/fed';
    ...
    const onSubmitBED = async (e) => {
        ...
        const url ='http://localhost:8000/api/about/bed';
    ...
    const onSubmitBio = (e) => {
        ...
        const url ='http://localhost:8000/api/about/About-144-867-936';
    ...
    const deleteFed = (delfed) => {
        const res = axios.delete(`http://localhost:8000/api/about/fed/${delfed}`);
    ...
    const deleteBed = (delbed) => {
        const res = axios.delete(`http://localhost:8000/api/about/bed/${delbed}`);
